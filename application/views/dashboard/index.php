        ...
        <div class="widget widget-wallet-one">
            ...
            <ul class="list-group list-group-media">
                <li class="list-group-item ">
                    <div class="media">
                        <div class="me-3">
                            <img alt="avatar" src="<?php echo ADMIN_THEME; ?>src/assets/img/netflix.svg" class="img-fluid rounded-circle">
                        </div>
                ...
                <li class="list-group-item">
                    <div class="media">
                        <div class="me-3">
                            <img alt="avatar" src="<?php echo ADMIN_THEME; ?>src/assets/img/apple-app-store.svg" class="img-fluid rounded-circle">
                        </div>
                        <div class="media-body">
            ...
            <div class="widget-content">
                <div class="table-responsive">
                    <table class="table">
                        ...
                        <tbody>
                            <tr>
                                <td><div class="td-content customer-name"><img src="<?php echo ADMIN_THEME; ?>src/assets/img/profile-13.jpeg" alt="avatar"><span>Luke Ivory</span></div></td>
                            ...
                            <tr>
                                <td><div class="td-content customer-name"><img src="<?php echo ADMIN_THEME; ?>src/assets/img/profile-7.jpeg" alt="avatar"><span>Andy King</span></div></td>
                            ...
                            <tr>
                                <td><div class="td-content customer-name"><img src="<?php echo ADMIN_THEME; ?>src/assets/img/profile-10.jpeg" alt="avatar"><span>Laurie Fox</span></div></td>
                            ...
                            <tr>
                                <td><div class="td-content customer-name"><img src="<?php echo ADMIN_THEME; ?>src/assets/img/profile-5.jpeg" alt="avatar"><span>Ryan Collins</span></div></td>
                            ...
                            <tr>
                                <td><div class="td-content customer-name"><img src="<?php echo ADMIN_THEME; ?>src/assets/img/profile-4.jpeg" alt="avatar"><span>Irene Collins</span></div></td>
                            ...
                            <tr>
                                <td><div class="td-content customer-name"><img src="<?php echo ADMIN_THEME; ?>src/assets/img/profile-11.jpeg" alt="avatar"><span>Sonia Shaw</span></div></td>
            ...
            <div class="widget-content">
                <div class="table-responsive">
                    <table class="table table-scroll">
                        ...
                        <tbody>
                            <tr>
                                <td><div class="td-content product-name"><img src="<?php echo ADMIN_THEME; ?>src/assets/img/product-headphones.jpg" alt="product"><div class="align-self-center"><p class="prd-name">Headphone</p><p class="prd-category text-primary">Digital</p></div></div></td>
                            ...
                            <tr>
                                <td><div class="td-content product-name"><img src="<?php echo ADMIN_THEME; ?>src/assets/img/product-shoes.jpg" alt="product"><div class="align-self-center"><p class="prd-name">Shoes</p><p class="prd-category text-warning">Faishon</p></div></div></td>
                            ...
                            <tr>
                                <td><div class="td-content product-name"><img src="<?php echo ADMIN_THEME; ?>src/assets/img/product-watch.jpg" alt="product"><div class="align-self-center"><p class="prd-name">Watch</p><p class="prd-category text-danger">Accessories</p></div></div></td>
                            ...
                            <tr>
                                <td><div class="td-content product-name"><img src="<?php echo ADMIN_THEME; ?>src/assets/img/product-laptop.jpg" alt="product"><div class="align-self-center"><p class="prd-name">Laptop</p><p class="prd-category text-primary">Digital</p></div></div></td>
                            ...
                            <tr>
                                <td><div class="td-content product-name"><img src="<?php echo ADMIN_THEME; ?>src/assets/img/product-camera.jpg" alt="product"><div class="align-self-center"><p class="prd-name">Camera</p><p class="prd-category text-primary">Digital</p></div></div></td>
