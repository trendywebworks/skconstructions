...
$can_delete = isset($allow_delete) && $allow_delete === true && isset($userdata['role_id']) && $userdata['role_id'] == 1 && isset($titles['delete']);
?>
<div class="row">                
                        ...
                        ?>
                            <tr>
                                ...
                                <?php } ?>
                                    ...
                                    <?php if($can_delete) { ?>
                                        <a href="<?php echo base_url($titles['delete']).'/'.$li['id']; ?>" class="sk-action-btn sk-action-delete bs-tooltip" data-bs-toggle="tooltip" data-bs-placement="top" title="" data-original-title="Delete" data-bs-original-title="Delete" aria-label="Delete" onclick="return confirm('Are you sure you want to delete this?');"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" class="feather feather-trash-2"><polyline points="3 6 5 6 21 6"></polyline><path d="M19 6l-1 14a2 2 0 0 1-2 2H8a2 2 0 0 1-2-2L5 6"></path><path d="M10 11v6"></path><path d="M14 11v6"></path><path d="M8 6V4a1 1 0 0 1 1-1h6a1 1 0 0 1 1 1v2"></path></svg></a>
                                    <?php } ?>
                                    </div>
