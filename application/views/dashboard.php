<style>
    ...
    .daily-expense-card .daily-expense-detail {
	    ...
	    .dashboard-summary-card .widget-content .w-icon {
		    ...
		    .dashboard-stat-card .widget-content {
		        padding: 20px;
		    }
		    .dashboard-stat-card .w-numeric-value {
		        position: static;
		        align-items: center;
		        padding: 0;
		        color: #515365;
		    }
		    .dashboard-stat-card .w-numeric-value .w-icon {
		        flex: 0 0 45px;
		    }
		    .dashboard-stat-card .w-numeric-value .w-content {
		        min-width: 0;
		        text-align: right;
		    }
		    .dashboard-stat-card .w-numeric-value .w-value {
		        margin-bottom: 0;
		        line-height: 1.2;
		    }
		</style>
    ...
    <div class="col-xl-4 col-lg-6 col-md-6 col-sm-6 col-12 layout-spacing">
	    ...
	    <div class="col-xl-4 col-lg-6 col-md-6 col-sm-6 col-12 layout-spacing">
		    ...
		    <div class="col-xl-4 col-lg-6 col-md-6 col-sm-12 col-12 layout-spacing">
		        ...
		        <div class="widget-one widget dashboard-stat-card mt-4">
		            <div class="widget-content">
		                <div class="w-numeric-value">
		                    <div class="w-icon">
