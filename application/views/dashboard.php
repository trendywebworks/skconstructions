        ...
        <div class="widget widget-activity-four">
            ...
            <div class="widget-content">
                        ...
                        if(isset($purchases))
                        {
                            ...
                            ?>
                                <div class="item-timeline timeline-primary">
                                    ...
                                    <div class="t-text">
                                        <p><span>Reference No : <?php echo $pur['reference_no']; ?></span> , Amount : <?php echo $pur['total_amount']; ?></p>
                                        <!-- <span class="badge">Pending</span> -->
                                        <p class="t-time"><?php echo toDMTDateFormat($pur['created_at']); ?></p>
                                    </div>
                                </div>
                            <?php
                            }
                ...
                <div class="tm-action-btn">
                    <a href="<?php echo base_url(); ?>purchase-list"><span>View All</span> <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-arrow-right"><line x1="5" y1="12" x2="19" y2="12"></line><polyline points="12 5 19 12 12 19"></polyline></svg></a>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="task-action">
                    <div class="dropdown">
                        ...
                        <div class="dropdown-menu left" aria-labelledby="pendingTask" style="will-change: transform;">
                            <a class="dropdown-item" href="<?php echo base_url(); ?>daily-entry-list">View List</a>
            ...
            <div class="widget-content">
                ...
                if(isset($transactions))
                {
                    ...
                    { 
                        ...
                        $short=mb_strtoupper(implode('',$matches[0]));

                        $rate = 'dec';
                        $rate_sym = '-';
                        if($tra['expense_type'] == 'credit')
                        {
                            $rate = 'inc';
                            $rate_sym = '+';
                        }
                        ...
                        <div class="transactions-list">
                            <div class="t-item">
                                <div class="t-company-name">
                                    <div class="t-icon">
                                        <div class="avatar">
                                            <span class="avatar-title"><?php echo substr($short, 0, 2); ?></span>
                                        </div>
                                    </div>
                                    <div class="t-name">
                                        <h4><?php echo $tra['expense_id']; ?></h4>
                                        <p class="meta-date"><?php echo toDMTDateFormat($tra['created_at']); ?></p>
                                    </div>

                                </div>
                                <div class="t-rate rate-<?php echo $rate; ?>">
                                    <p><span><?php echo $rate_sym; ?><?php echo $tra['amount']; ?></span></p>
                                </div>
                            </div>
                        </div>
                    <?php
