...
class Paytopartner_Model extends MY_Model
{
	...
	public function getAllPayList()
	{
		...
		$select = "$this->_table.id,$this->_table.created_at,$this->_table.entry_date,$this->_partner_table.full_name as partner_name, CONCAT('₹', format($this->_table.amount,2)) as amount,$this->_table.pay_for,$this->_table.pay_type,$this->_table.status,$this->_table.remarks";
