    ...
    if (ParsedObject.settings.layout.darkMode) {
      ...
      */
      var options1 = {
        ...
        series: [{
            name: 'Total Expense',
            data: (document.getElementById("monthlyTotalExpenses").value).split(',')
        }, {
            name: 'Total Income',
            data: (document.getElementById("monthlyTotalIncome").value).split(',')
        }],
      ...
      */
      var d_2options1 = {
        ...
        series: [{
            name: 'Income',
            data: (document.getElementById("daily_profit").value).split(',')
        },{
            name: 'Expense',
            data: (document.getElementById("daily_lose").value).split(',')
        }],
        xaxis: {
            labels: {
                show: false,
      ...
      */
      var options = {
          ...
          series: [parseFloat(document.getElementById("daily_expense").value), parseFloat(document.getElementById("vehicle_expense").value),parseFloat( document.getElementById("office_expense").value)],
          labels: ['Daily', 'Vehicle', 'Office'],
