            ...
            <thead>
                ...
                <tbody>
                    <tr>
                        ...
                        <td>Yashpal</td>
                        <td>Bharti</td>
                        <td>yashpal.bharti@gmail.com</td>
                        <td>
                            Editor
                        </td>
                        <td>He is Handling the Editing Part</td>
                        <td>
                    ...
                    <tr>
                        ...
                        <td>Satish</td>
                        <td>Kurrey</td>
                        <td>satishkurrey@gmail.com</td>
                        <td>
                            Admin
                        </td>
                        <td>He manage all application </td>
                        <td>
                            <div class="form-check form-switch form-check-inline form-switch-primary">
                                <input class="form-check-input" type="checkbox" role="switch" id="form-switch-primary" checked>
