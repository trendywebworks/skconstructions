        ...
        <div class="navbar-nav theme-brand flex-row  text-center">
            <div class="nav-logo">
                ...
                <div class="nav-item theme-text">
                    <a href="index.php" class="nav-link"> SK Constructions </a>
                </div>
            </div>
        ...
        <ul class="list-unstyled menu-categories" id="accordionExample">
            ...
            <li class="menu">
                ...
                <ul class="collapse submenu list-unstyled" id="apps" data-bs-parent="#accordionExample">
                    <li>
                        <a href="daily-entry-list.php">View List</a>
                    </li>
                    <li>
                        <a href="daily-entry-add.php">Add New</a>
                    </li>                            
                </ul>
            </li>
            ...
            <li class="menu">
                ...
                <ul class="collapse submenu list-unstyled" id="marketloans" data-bs-parent="#accordionExample">
                    <li>
                        <a href="market-loans-list.php">View List</a>
                    </li>
                    <li>
                        <a href="market-loans-add.php">Add New</a>
                    </li>                            
                </ul>
            </li>
            ...
            <li class="menu">
                ...
                <ul class="collapse submenu list-unstyled" id="vehiclefinance" data-bs-parent="#accordionExample">
                    <li>
                        <a href="vehicles-expenses-list.php">View List</a>
                    </li>
                    <li>
                        <a href="vehicles-expenses-add.php">Add New</a>
                    </li>                            
                </ul>
            </li>
            ...
            <li class="menu">
                ...
                <ul class="collapse submenu list-unstyled" id="purchase" data-bs-parent="#accordionExample">
                    <li>
                        <a href="purchase-list.php">View List</a>
                    </li>
                    <li>
                        <a href="purchase-add.php">Add New</a>
                    </li>
                </ul>
            </li>
            ...
            <li class="menu">
                ...
                <ul class="collapse submenu list-unstyled" id="gstbill" data-bs-parent="#accordionExample">
                    <li>
                        <a href="gst-bill-list.php">View List</a>
                    </li>
                    <li>
                        <a href="gst-bill-add.php">Add New</a>
                    </li>
                </ul>
            </li>
            ...
            <li class="menu">
                ...
                <ul class="collapse submenu list-unstyled" id="ccaccount" data-bs-parent="#accordionExample">
                    <li>
                        <a href="cc-account-list.php">View List</a>
                    </li>
                    <li>
                        <a href="cc-account-add.php">Add New</a>
                    </li>
                </ul>
            </li>
            ...
            <li class="menu">
                ...
                <ul class="collapse submenu list-unstyled" id="products" data-bs-parent="#accordionExample">
                    <li>
                        <a href="products-list.php">View List</a>
                    </li>
                    <li>
                        <a href="products-add.php">Add New</a>
                    </li>
                </ul>
            </li>
            ...
            <li class="menu">
                ...
                <ul class="collapse submenu list-unstyled" id="officeexpense" data-bs-parent="#accordionExample">
                    <li>
                        <a href="office-expense-list.php">View List</a>
                    </li>
                    <li>
                        <a href="office-expense-add.php">Add New</a>
                    </li>
                </ul>
            </li>
            ...
            <li class="menu">
                ...
                <ul class="collapse submenu list-unstyled" id="staffloans" data-bs-parent="#accordionExample">
                    <li>
                        <a href="staff-loans-list.php">View List</a>
                    </li>
                    <li>
                        <a href="staff-loans-add.php">Add New</a>
                    </li>
                </ul>
            </li>
            ...
            <li class="menu">
                ...
                <ul class="collapse submenu list-unstyled" id="reports" data-bs-parent="#accordionExample">
                    <li>
                        <a href="reports-daily.php">Daily Reports</a>
                    </li>
                    <li>
            ...
            <li class="menu">
                ...
                <ul class="collapse submenu list-unstyled" id="sites" data-bs-parent="#accordionExample">
                    <li>
                         <a href="sites-list.php">View List</a>
                    </li>
                    <li>
                        <a href="sites-add.php">Add New</a>
                    </li>
                </ul>
            </li>
            ...
            <li class="menu">
                ...
                <ul class="collapse submenu list-unstyled" id="partners" data-bs-parent="#accordionExample">
                    <li>
                        <a href="partners-list.php">View List</a>
                    </li>
                    <li>
                        <a href="partners-add.php">Add New</a>
                    </li>
                </ul>
            </li>
            ...
            <li class="menu">
                ...
                <ul class="collapse submenu list-unstyled" id="vehicles" data-bs-parent="#accordionExample">
                    <li>
                        <a href="vehicles-list.php">View List</a>
                    </li>
                    <li>
                        <a href="vehicles-add.php">Add New</a>
                    </li>                            
                </ul>
            </li>
            ...
            <li class="menu">
                ...
                <ul class="collapse submenu list-unstyled" id="officestaff" data-bs-parent="#accordionExample">
                    <li>
                        <a href="office-staff-list.php">View List</a>
                    </li>
                    <li>
                        <a href="office-staff-add.php">Add New</a>
                    </li>
                </ul>
            </li> 
            ...
            <li class="menu">
                ...
                <ul class="collapse submenu list-unstyled" id="loanparty" data-bs-parent="#accordionExample">
                    <li>
                        <a href="loan-party-list.php">View List</a>
                    </li>
                    <li>
                        <a href="loan-party-add.php">Add New</a>
                    </li>
                </ul>
            </li>
            ...
            <li class="menu">
                ...
                <ul class="collapse submenu list-unstyled" id="expensetype" data-bs-parent="#accordionExample">
                    <li>
                        <a href="expense-type-list.php">View List</a>
                    </li>
                    <li>
                        <a href="expense-type-add.php">Add New</a>
                    </li>
                </ul>
            </li>
            ...
            <li class="menu">
                ...
                <ul class="collapse submenu list-unstyled" id="suppliers" data-bs-parent="#accordionExample">
                    <li>
                        <a href="suppliers-list.php">View List</a>
                    </li>
                    <li>
                        <a href="suppliers-add.php">Add New</a>
                    </li>
                </ul>
            </li>
            ...
            <li class="menu">
                ...
                <ul class="collapse submenu list-unstyled" id="banks" data-bs-parent="#accordionExample">
                    <li>
                        <a href="banks-list.php">View List</a>
                    </li>
                    <li>
                        <a href="banks-add.php">Add New</a>
                    </li>
                </ul>
            </li>
            ...
            <li class="menu">
                ...
                <ul class="collapse submenu list-unstyled" id="users" data-bs-parent="#accordionExample">
                    <li>
                        <a href="users-list.php">View List</a>
                    </li>
                    <li>
                        <a href="users-add.php">Add New</a>
                    </li>
                </ul>
            </li>                                    
            ...
            <li class="menu">
                ...
                <ul class="collapse submenu list-unstyled" id="profile" data-bs-parent="#accordionExample">
                    <li>
                        <a href="profile-setting.php">Settings</a>
                    </li>
                </ul>
            </li>  
