        ...
        <div class="layout-px-spacing">
            ...
            <div class="middle-content container-xxl p-0">
                ...
                <div class="titlebox seperator-header layout-top-spacing">
                    <div class="row">
                        <div class="col-xs-12 col-sm-8">
                            <h1>CC Account - <span>View List</span></h1>
                        </div>
                        <div class="col-xs-12 col-sm-4 text-right">
                            <a href="cc-account-add.php" class="btn btn-dark mb-2 me-4 _effect--ripple waves-effect waves-light">Add New</a>
                        </div>
                    </div>
                </div>
                ...
                <?php
                    ...
                    require_once('partials/cc-account/list.php'); 
                ?>
